      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-black/80 border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button className="px-5 py-2.5 text-gray-300 hover:text-white transition-colors">
              Sign In
            </button>
            <button className="px-6 py-2.5 bg-white text-black rounded-lg hover:bg-gray-200 transition-all font-semibold shadow-lg hover:shadow-xl hover:scale-105 transform">
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <button className="group relative px-8 py-4 bg-white text-black rounded-xl font-semibold text-lg hover:shadow-2xl transition-all hover:scale-105 transform w-full sm:w-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 border border-zinc-700 p-12 md:p-16 text-center">
            ...
            <div className="relative z-10">
              ...
              <button className="px-10 py-4 bg-white text-black rounded-xl font-semibold text-lg hover:shadow-2xl transition-all hover:scale-105 transform">
