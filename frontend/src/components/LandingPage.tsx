  ...
  return (
    ...
    >
      ...
      <nav
        ...
        style={{
          backgroundColor:
            "color-mix(in srgb, var(--navbar-bg) 80%, transparent)",
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            {/* Badge */}
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 transition-colors"
              style={{
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
              ...
              <span
                ...
                style={{
                  background:
                    "linear-gradient(to right, var(--accent-primary), var(--text-tertiary))",
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <button
                ...
                className="group px-8 py-4 rounded-xl font-semibold text-lg transition-all w-full sm:w-auto flex items-center justify-center gap-2 hover:scale-105 transform"
                style={{
                  backgroundColor: "var(--card-bg)",
                  border: "1px solid var(--card-border)",
                  color: "var(--text-primary)",
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="p-6 rounded-2xl backdrop-blur-sm transition-colors"
                  style={{
                    backgroundColor: "var(--card-bg)",
                    border: "1px solid var(--card-border)",
                  }}
              ...
              <div key={i} className="relative">
                {i < 2 && (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to right, var(--border-primary), transparent)",
                    }}
                  />
                )}
                <div
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                quote:
                  "CareerPath AI helped me land a position at Google. The mock interviews were incredibly realistic!",
                name: "Sarah Chen",
                role: "Software Engineer at Google",
              },
              {
                quote:
                  "The AI feedback was spot-on. It identified exactly what I needed to work on for my Amazon interview.",
                name: "Michael Rodriguez",
                role: "Product Manager at Amazon",
              },
              {
                quote:
                  "I went from nervous to confident in just two weeks. The practice made all the difference.",
                name: "Emily Watson",
      ...
      {showDemo && (
        ...
        >
          ...
          >
            <iframe
              src="https://www.youtube.com/embed/XW2rR9C5MCk?autoplay=1&rel=0"
              title="CareerPath AI Demo"
